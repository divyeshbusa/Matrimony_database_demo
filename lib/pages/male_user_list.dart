...
class maleUser extends StatefulWidget{
  @override
  State<maleUser> createState() => _maleUserState();
}

class _maleUserState extends State<maleUser> {
      ...
      child: Scaffold(
        ...
        body: Container(
          ...
          child: FutureBuilder<List<UserModel>>(
              ...
              future: isGetData ? db.getDataOfMaleUser() : null),
        ),
      ),
    );
  }
